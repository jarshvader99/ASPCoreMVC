        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data.collections, function (key, val) {
                    console.log('card count: ' + i)
                    if (i && (i % 3 === 0) || j === 0) {
                        divWrapperOpen = '<div class="card-group">';
                        divWrapperClose = '</div>';
                        console.log('add and remove card');
                    }

                    //neighborhood.append(divWrapperOpen);
                    //neighborhood.prepend(divWrapperClose);
                    neighborhood.append(
                         '<div class="box"><div class="card mb-3 pt-1"><h3 class="card-header"><a href="' + data.collections[i].collection.url + '" target="_blank">' + data.collections[i].collection.title + '</a></h3>' +
                        '<div class="card-body">' +
